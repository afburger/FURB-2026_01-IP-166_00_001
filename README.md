<!-- [@] INICIO atualizar -->
[AVA3]: <https://ava3.furb.br/course/view.php?id=53160> "AVA3"  
[Plano de Ensino]: <https://ava3.furb.br/course/view.php?id=53160&section=1> "Plano de Ensino"  
...
[ProjetoPratico]: <./ProjetoPratico/src> "ProjetoPratico"

# FURB-2026/01 CMP.0166.00.001-0
Repositório destinado a matéria de IP (Introdução à Programação) lecionada na FURB no Semestre 01/2026 para o curso de Bacharelado de Ciências da Computação (BCC).  
...
Já para desenvolver a parte prática precisaremos de um computador (PC/Mac) com um dos sistemas operacionais: Windows, Linux ou MacOS. O material teórico (textos e videoaulas) até podem ser trabalhados com dispositivos móveis (smartphones ou tablets), mas a parte prática exige um equipamento notebook ou desktop.
